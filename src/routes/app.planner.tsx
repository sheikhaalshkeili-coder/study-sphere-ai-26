...
function ClassroomIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-5" fill="none">
      ...
      <circle cx="12" cy="11" r="1.7" stroke="currentColor" strokeWidth="2" />
      <path d="M8.5 15c.7-1.4 2-2 3.5-2s2.8.6 3.5 2M2 19h20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
