...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plan homework, study smarter with AI, and stay on top of exams — all in one polished student app." },
      { name: "theme-color", content: "#6d5cff" },
      { property: "og:title", content: "StudySphere AI" },
      { property: "og:description", content: "Plan, study, and ace exams with your AI-powered student companion." },
